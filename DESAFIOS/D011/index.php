...
<body>
    ...
    <section>
        ...
        <p>O produto que custava R$<?=number_format($preco, 02, ",",".")?> com <strong><?=$reaj?>% de aumento</strong> vai passar a custar <strong>R$<?=number_format($novo, 02, "," , ".")?></strong> a partir de agora.</p>
        </section>
        <script>
            mudaValor()
            function mudaValor() {
